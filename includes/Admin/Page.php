					...
					<div class="st-step__body">
						...
						<?php elseif ( $patched ) : ?>
							<div class="st-step__actions">
								<span class="st-inline-ok st-inline-ok--lg"><span class="dashicons dashicons-yes-alt"></span><?php esc_html_e( 'Polylang is already patched.', 'supertext-polylang' ); ?></span>
