...
class String_Table {
		...
		wp_localize_script(
			...
			array(
				...
				'i18n'        => array(
					...
					'ordering'      => __( 'Ordering…', 'supertext-polylang' ),
					'translating'   => __( 'Translating…', 'supertext-polylang' ),
				),
			)
		);
	}
	...
	public static function render( array $args ): void {
		...
		$fid          = self::FORM_ID;
		$confirm      = __( 'Start a Fused translation order for the checked rows?', 'supertext-polylang' );
		?>
